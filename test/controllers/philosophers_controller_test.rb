...
class PhilosophersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create philosopher" do
    assert_difference("Philosopher.count") do
      post philosophers_url, params: { philosopher: { biography: @philosopher.biography, birth_year: @philosopher.birth_year, death_year: @philosopher.death_year, phil_first_name: @philosopher.phil_first_name, phil_last_name: @philosopher.phil_last_name } }
    end
  ...
  test "should update philosopher" do
    patch philosopher_url(@philosopher), params: { philosopher: { biography: @philosopher.biography, birth_year: @philosopher.birth_year, death_year: @philosopher.death_year, phil_first_name: @philosopher.phil_first_name, phil_last_name: @philosopher.phil_last_name } }
